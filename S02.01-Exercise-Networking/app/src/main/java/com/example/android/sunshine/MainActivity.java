...
public class MainActivity extends AppCompatActivity {
    ...
    private void loadWeatherData() {
        String preference = SunshinePreferences.getPreferredWeatherLocation(this);
        GetWeatherTask.execute(preference);
    }
        ...
        protected String[] doInBackground(String... params) {
            if(params) {
                ...
                try {
                    ...
                    jsonResults = OpenWeatherJsonUtils.getSimpleWeatherStringsFromJson(MainActivity.this, weatherResponse);
                    return  jsonResults;
                } catch (IOException e) {
                    e.printStackTrace();
                    return null;
